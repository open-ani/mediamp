...
public abstract class BufferedSeekableInput(
     ...
     */
    @TestOnly
    internal val bufferedOffsetRange: LongRange get() = bufferedOffsetStart..<bufferedOffsetEndExcl
    ...
    private fun checkClosed() {
        if (closed) throw IllegalStateException("This BufferedSeekableInput is closed")
    }
    ...
    override fun toString(): String {
        return "BufferedSeekableInput(position=$position, bytesRemaining=$bytesRemaining)"
    }
}
...
internal fun Long.checkToInt(): Int {
