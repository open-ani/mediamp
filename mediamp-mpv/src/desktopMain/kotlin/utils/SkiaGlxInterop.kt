 ...
 * their lifetime is tied to [SkiaGlxInterop] and changes with redrawer recreation.
 */
internal data class GlxRenderEnvironment(
    ...
    override val identity: Any
        get() = GlxRenderEnvironmentIdentity(shareContext)

    override val renderDeviceToken: Long get() = shareContext

    @OptIn(InternalMediampApi::class)
    override fun attach(handlePtr: Long): Boolean =
        nAttachRenderEnvironmentOpenGL(handlePtr, component, shareContext, drawable, window)
}

internal data class GlxRenderEnvironmentIdentity(
    val shareContext: Long,
)

/**
 * Reflective access to Skiko 0.9.37.4's Linux GLX redrawer.
 *
 ...
 */
internal class SkiaGlxInterop(private val layer: SkiaLayer) : SkiaOpenGLInterop {
    ...
    private fun renderEnvironment(redrawer: Any, access: RedrawerAccess): GlxRenderEnvironment {
    ...
    fun renderEnvironment(): GlxRenderEnvironment {
